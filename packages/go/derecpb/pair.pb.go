...
type PairRequestMessage struct {
	...
	// still pair. **Scheduled for removal in v0.0.5.** A sender populating
	// `supportedTransports` MUST also set this to a single
...
func (x *PairRequestMessage) GetSupportedTransports() []*TransportProtocol {
	if x != nil {
