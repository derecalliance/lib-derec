...
type StoreShareRequestMessage struct {
	...
	//   - Non-empty: the responder routes this exchange's response to any one
	//     of these, in the order given, and leaves the stored endpoints
	//     unchanged. Delivery to any one is success.
	//
	// Was a singular field through 0.0.2. A 0.0.2 reader decoding a
	// multi-entry list merges them and sees only the last, so an
	// application still talking to one should order accordingly.
	ReplyTo []*TransportProtocol `protobuf:"bytes,8,rep,name=replyTo,proto3" json:"replyTo,omitempty"`
...
const file_storeshare_proto_rawDesc = "" +
	"\n" +
	"\x10storeshare.proto\x12 org.derecalliance.derec.protobuf\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\fresult.proto\x1a\x17transportprotocol.proto\"\x94\x03\n" +
	...
	"\ttimestamp\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12M\n" +
	"\areplyTo\x18\b \x03(\v23.org.derecalliance.derec.protobuf.TransportProtocolR\areplyTo\x12!\n" +
	"\treplicaId\x18\t \x01(\x04H\x00R\treplicaId\x88\x01\x01B\f\n" +
	"\n" +
	"_replicaId\"\x83\x02\n" +
...
var file_storeshare_proto_depIdxs = []int32{
	...
	4, // 2: org.derecalliance.derec.protobuf.StoreShareResponseMessage.result:type_name -> org.derecalliance.derec.protobuf.DeRecResult
	2, // 3: org.derecalliance.derec.protobuf.StoreShareResponseMessage.timestamp:type_name -> google.protobuf.Timestamp
