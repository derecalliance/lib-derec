...
type GetShareRequestMessage struct {
	...
	//
	// Deprecated: Marked as deprecated in getshare.proto.
	...
	ReplyToTransports []*TransportProtocol `protobuf:"bytes,6,rep,name=replyToTransports,proto3" json:"replyToTransports,omitempty"`
...
func (x *GetShareRequestMessage) GetReplyToTransports() []*TransportProtocol {
	if x != nil {
...
const file_getshare_proto_rawDesc = "" +
	"\n" +
	"\x0egetshare.proto\x12 org.derecalliance.derec.protobuf\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\fresult.proto\x1a\x17transportprotocol.proto\"\x80\x03\n" +
	...
	"\areplyTo\x18\x04 \x01(\v23.org.derecalliance.derec.protobuf.TransportProtocolB\x02\x18\x01H\x00R\areplyTo\x88\x01\x01\x12a\n" +
	"\x11replyToTransports\x18\x06 \x03(\v23.org.derecalliance.derec.protobuf.TransportProtocolR\x11replyToTransports\x12!\n" +
...
var file_getshare_proto_depIdxs = []int32{
	...
	3, // 2: org.derecalliance.derec.protobuf.GetShareRequestMessage.replyToTransports:type_name -> org.derecalliance.derec.protobuf.TransportProtocol
	4, // 3: org.derecalliance.derec.protobuf.GetShareResponseMessage.result:type_name -> org.derecalliance.derec.protobuf.DeRecResult
	2, // 4: org.derecalliance.derec.protobuf.GetShareResponseMessage.timestamp:type_name -> google.protobuf.Timestamp
