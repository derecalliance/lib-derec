...
fn create_ok_response_with_committed_bytes(committed_bytes: Vec<u8>) -> GetShareResponseMessage {
...
fn create_response_with_status(status: i32, committed_bytes: Vec<u8>) -> GetShareResponseMessage {
    GetShareResponseMessage {
        share_algorithm: 0,
        committed_de_rec_share: committed_bytes,
        result: Some(DerecResult {
