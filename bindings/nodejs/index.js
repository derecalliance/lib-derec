...
const roleHelper = 2;
const roleSharer = 0;
const createContactMessageResult = derec.create_contact_message(channelId, "https://example.com/alice");
console.log("create_contact_message:", createContactMessageResult);
const producePairingRequestMessageResult = derec.produce_pairing_request_message(roleHelper, "https://example.com/helper", createContactMessageResult.wire_bytes);
