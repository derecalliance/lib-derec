...
let produce_pairing_request_message_result = derec.produce_pairing_request_message(
    channel_id,
    role_helper,
...
let produce_pairing_response_message_result = derec.produce_pairing_response_message(
    role_sharer,
...
let process_pairing_response_message_result = derec.process_pairing_response_message(
    create_contact_message_result.contact_message,
