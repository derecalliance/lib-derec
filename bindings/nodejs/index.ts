...
const verificationResponse = derec.generate_verification_response(
  secretId,
  someChannel,
  someSharedKey,
  someShare,
...
const shareRequest1 = derec.generate_share_request(
  1n,
  secretId,
  version,
  sharedKeys.get(1n)!
...
const shareRequest2 = derec.generate_share_request(
  2n,
  secretId,
  version,
  sharedKeys.get(2n)!
...
const shareRequest3 = derec.generate_share_request(
  3n,
  secretId,
  version,
  sharedKeys.get(3n)!
...
const producePairingRequestMessageResult = derec.produce_pairing_request_message(
  ...
  createContactMessageResult.wire_bytes
);
console.log(
...
const producePairingResponseMessageResult = derec.produce_pairing_response_message(
  roleSharer,
  producePairingRequestMessageResult.wire_bytes,
  createContactMessageResult.secret_key_material
);
console.log(
...
const processPairingResponseMessageResult = derec.process_pairing_response_message(
  createContactMessageResult.wire_bytes,
  producePairingResponseMessageResult.wire_bytes,
  producePairingRequestMessageResult.secret_key_material
);
console.log(
