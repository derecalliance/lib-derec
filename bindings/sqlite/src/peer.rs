...
use crate::stores::{
    SqliteChannelStore, SqliteSecretStore, SqliteShareStore, SqliteStateStore,
...
impl Peer {
    ...
    fn with_full_options(
        ...
        let user_secret_store = SqliteUserSecretStore::new(connection.clone());
        let state_store = SqliteStateStore::new(connection);
